...
Owner: current documentation agent. Scope: README, docs/screenshots, and this workstream. Preserve unrelated changes in devlog/current.md. No application or detector changes.
